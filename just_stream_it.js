...
searchbestMovies.then(async (responseData)=>{
    ...
    const display_title = document.querySelector("#title_best_movies");
    const display_gender = document.querySelector("#gender_best_movies");
    const display_releaseDate = document.querySelector("#release_date_best_movies");
    const display_rated = document.querySelector("#rated_best_movies");
    const display_imdbScore = document.querySelector("#imdb_score_best_movies");
    const display_filmDirector = document.querySelector("#film_director_best_movies");
    const display_listOfActors = document.querySelector("#actors_best_movies");
    const display_duration = document.querySelector("#duration_best_movies");
    const display_country = document.querySelector("#country_best_movies");
    const display_movieAbstract = document.querySelector("#movie_abstract_best_movies"); 
    const bestMovieImage = `<img src="${movieImage}"/>`;
    const display_movieImage = document.querySelector("#best_movies_images"); 
    ...
    display_country.innerHTML = "Country: " + country;
    display_movieAbstract.innerHTML = "Movie abstract: " + movieAbstract;
    display_moviesImage.insertAdjacentHTML("afterbegin", bestMovieImage);
