...
searchbestMovie.then(async (responseData)=>{
  ...
  setModalValues(
    ...
    var span_best_movie_image = document.getElementById("modal_best_movie_image");
    span_best_movie_image.insertAdjacentHTML("afterbegin", bestMovieImage);
                        ...
                        try {
                            ...
                            $(function () {
                                $('.'+ className).click(function () {
                                    ...
                                    var modal = $('#'+href);
                                    var movieImageCategory = `<img src="${movie.image_url}"/>`;
                                    var span = document.getElementById(categoryName + "_image");
                                    span.insertAdjacentHTML("afterbegin", movieImageCategory);
